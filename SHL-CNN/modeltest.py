...
x_train_1, x_val_1, y_train_1, y_val_1 = train_test_split(
	x_train_1,y_train_1,test_size=.2,random_state=random.seed(time.time()))
...
d = Lambda(lrn)(c)
n = Activation('sigmoid')(d)
e = Conv2D(64,kernel_size=(7,7),activation='sigmoid',padding='same',data_format='channels_last',kernel_initializer=intial)(n)
f = Lambda(lrn)(e)
m = Activation('sigmoid')(f)
g = MaxPooling2D(pool_size=(3, 3),strides=2)(m)
