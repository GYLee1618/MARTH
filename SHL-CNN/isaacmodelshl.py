...
for ii in range(EPOCHS):
  ...
  for jj in range(num_batches): 
    ...
    if rng < .5 and batch1_count < len(x_train_1_batches):
      ...
      train1error,train1acc = model1.fit(x_train_1_b, y_train_1_b,batch_size=1,epochs=1)
      ...
      train2error,train2acc = model2.fit(x_train_2_b,y_train_2_b,batch_size=1,epochs=1)
